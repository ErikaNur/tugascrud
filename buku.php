                ...
                <div class="d-flex flex-row">
                    <div>
                        <form class="d-flex" action="" method="POST">
                            <input class="form-control me-2" type="text" placeholder="title/writer/publisher/release"
                                name="key">
                ...
                <table class="table table-bordered" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="20%"><img src="uploads/<?php echo $value['Cover_buku'] ?>"
                                    height="50%" width="50%" alt="" srcset=""></td>
                            ...
                            <td class="text-center">
                                ...
                                <a onclick="return confirm('Apakah yakin data akan di hapus?')"
                                    href="delete_buku.php?id=<?php echo $value['Id_buku']; ?>" class="btn btn-danger">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a onclick=" confirm('Apakah yakin data akan di hapus?')"
                                    href="delete_buku.php?id=<?php echo $value['Id_buku']; ?>" class="btn btn-danger">
                                    <span class="fa fa-trash"></span>
                                </a>
                            </td>
